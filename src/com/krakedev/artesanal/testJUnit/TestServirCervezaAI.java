...
public class TestServirCervezaAI {
    ...
    public void testServirCervezaCorrectamente() {
        Maquina maquina = new Maquina("S-001","Pilsener", "Rubia", 0.05, 1000);
    ...
    public void testNoServirPorFaltaDeCerveza() {
        Maquina maquina = new Maquina("S-002","Pilsener", "Rubia", 0.05, 1000);
    ...
    public void testServirCantidadExacta() {
        Maquina maquina = new Maquina("S-003","Pilsener", "Rubia", 0.1, 1000);
    ...
    public void testServirConMaquinaVacia() {
        Maquina maquina = new Maquina("S-004","Pilsener", "Rubia", 0.05, 1000);
    ...
    public void testServirConConstructorSinCapacidad() {
        Maquina maquina = new Maquina("S-005","IPA", "Amarga", 0.08);
    ...
    public void testServirMasDeLoDisponible() {
        Maquina maquina = new Maquina("S-006","Stout", "Negra", 0.07, 1000);
